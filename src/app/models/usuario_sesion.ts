...
export class usuario_sesion_model {
    ...
    informacion_activo: true;
    informacion_sexo: string;
    informacion_transporte: string;
    estatus_nombre: string;
    dispositivo_id: number;
    dispositivo_nombre: string;
    dispositivo_direccion_mac: string;
    informacion_valoracion_completa: boolean;
    informacion_num_familiares: number;
    instancia_id: number;
    tiempo_lecturas_minutos: number;
    informacion_token_sesion: string;
    informacion_token_sesion_fecha: string;
    informacion_embarazo?: number;
    auth_token: string;
    usuario_ca_tipo_usuario_id: number;
    informacion_sistema_medicion_clave: number;
    horario_inicio_sueno?: string;
    horario_fin_sueno?: string;
}
